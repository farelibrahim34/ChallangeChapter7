...
import com.example.logindatastorefix.view.SplashActivity
...
class NotificationHelper(val context : Context) {
    ...
    fun createNotif(tittle : String, message : String){
        ...
        val icon = BitmapFactory.decodeResource(context.resources, R.drawable.gambarbuku)
        val notification = NotificationCompat.Builder(context,CHANNEL_ID)
            .setSmallIcon(R.drawable.gambarbuku)
            .setLargeIcon(icon)
